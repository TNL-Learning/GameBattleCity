    ...
    createMap() {
        ...
        for (let i = 0; i < QUANTITY_CELL_ROW; i++) {
            for (let j = 0; j < QUANTITY_CELL_COL; j++) {
                ...
                this.blocks.push(new BlockTerrain(j * BLOCK_SIZE, i * BLOCK_SIZE, this.mapMatrix[i][j]));
            }
        }
    }
    ...
    createRandomMapMatrix() {
        ...
        let listIgnore = [];
        {
            ...
            for (let index = 0; index < listType.length; index++) {
                ...
                for (let i = 0; i < home.PlayerTeams.length; i++) {
                    this.PlayerTeams.push(home.PlayerTeams[i]);
                }
                for (let i = 0; i < home.RobotTeam.length; i++) {
                    this.RobotTeam.push(home.RobotTeam[i]);
                }
                for (let i = 0; i < home.blocks.length; i++) {
                    this.blocks.push(home.blocks[i]);
                }

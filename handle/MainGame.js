class BattleCity {
    ...
    initialize() {
        ...
        for (let i = 0; i< this.listGates.length; i++) {
            this.listRobot.push(this.listGates[i].Open());
        }
    ...
    updateBullet() {
        ...
        for (let i = 0; i < this.listBullets.length; i++) {
            ...
            for (let j = 0; j < this.listPlayer.length; j++) {
                if (this.listBullets[i].isHitEnemy(this.listPlayer[j])) {
                    needToCheck = false;
                    break;
                }
            }
            ...
            for (let j = 0; j < this.listRobot.length; j++) {
                if (this.listBullets[i].isHitEnemy(this.listRobot[j])) {
                    needToCheck = false;
                    break;
                }
            }
    ...
    renderFrame() {
        ...
        for (let i = 0; i < this.listRobot.length; i++) {
            this.listRobot[i].render(this.context);
        }
        // for (let i = 0; i < this.listGates.length; i++) {
